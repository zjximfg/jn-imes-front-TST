...
interface OutWarehouseRebarMemberProps {
  ...
  onFinish: (values: RebarMemberOutDataType[], sumOutQuantity: number, sumOutTheoreticalWeight: number) => void;
}
...
const OutWarehouseRebarMember: React.FC<OutWarehouseRebarMemberProps> = (props) => {
  ...
  const handleFinish = () => {
    ...
    onFinish(selectedRebarMemberOutList, sumOutQuantity, sumOutTheoreticalWeight);
  };
